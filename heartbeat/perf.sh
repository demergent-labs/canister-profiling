...
let heartbeat_ts = wasm_profiling("azle/.dfx/local/canisters/heartbeat/heartbeat.wasm");
let timer_ts = wasm_profiling("azle/.dfx/local/canisters/timer/timer.wasm");
...
heartbeat_perf(heartbeat_ts, "Azle");

output(file, "\n## Timer\n\n| |binary_size|setTimer|cancelTimer|\n|--:|--:|--:|--:|\n");
timer_perf(timer_mo, "Motoko");
timer_perf(timer_rs, "Rust");
timer_perf(timer_ts, "Azle");
